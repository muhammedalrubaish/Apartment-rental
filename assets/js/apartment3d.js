...
const FURNITURE = {
    ...
    living(R) {
        /* ترتيب الصالة مطابق لصورتها الفعلية:
           ...
           - كرسيان رماديان جنباً إلى جنب مقابل الطاولة الزجاجية، ووجه كلٍّ منهما نحو الشاشة. */
        ...
        const RUG_W = 2.0;
        const tableX = tvX;
        /* الكرسيان جنباً إلى جنب (واحد يمين وواحد يسار محور الطاولة) جنوب الطاولة الزجاجية،
           والطاولة أمامهما مباشرة ثم الشاشة. عرض الكرسي 0.54 وبينهما فراغ 0.18 */
        const chairZ = sofaZ + 0.43 + 0.14 + 0.27;       // نصف عمق الطاولة + فراغ + نصف عمق الكرسي
        const chairs = [
            [tableX - 0.36, chairZ],
            [tableX + 0.36, chairZ],
        ];
        ...
        const out = [
            ...
            // كرسيان رماديان جنباً إلى جنب خلف الطاولة، كلٌّ منهما مُدار ليواجه الشاشة مباشرة
            ...chairs.map(([cx, cz]) =>
